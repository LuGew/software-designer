 ...
 * @since 2020/5/12
 */
public class ByteStrategySpecification {
    Strategy<Long> strategy;

    @BeforeEach
    void setUp() {
        strategy = StrategyFactory.getStrategy("Byte");
    }
    ...
    @Test
    void givenTrueFormWhenInput1ThenOutput00000001() {
        assertThat(strategy.trueForm(1L))
                .isEqualTo("00000001".toCharArray());
    }
