 ...
 * @since 2020/5/12
 */
public class ShortStrategySpecification {
    Strategy<Long> strategy;

    @BeforeEach
    void setUp() {
        strategy = StrategyFactory.getStrategy("Short");
    }
    ...
    @Test
    void givenTrueFormWhenInput1ThenOutput0000000000000001() {
        assertThat(strategy.trueForm(1L))
                .isEqualTo("0000000000000001".toCharArray());
    }

  /*  @Test
    void givenTrueFormWhenInputNegative1ThenOutput10000000000000000000000000000001() {
        assertThat(strategy.trueForm((byte) -1))
